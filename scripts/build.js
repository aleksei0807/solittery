...
function build(previousSizeMap) {
  ...
  webpack(config).run((err, stats) => {
    ...
    if (homepagePath && homepagePath.indexOf('.github.io/') !== -1) {
      ...
      console.log(`You can control this with the ${chalk.green('homepage')} field in your ${
      ...
      if (homepagePath) {
        ...
        // no homepage
        console.log(`To override this, specify the ${chalk.green('homepage')} in your ${
          chalk.cyan('package.json')}.`)
        console.log('For example, add this to build it for GitHub Pages:')
        console.log()
        console.log(`  ${chalk.green('"homepage"')}${chalk.cyan(': ')}${chalk.green('"http://myname.github.io/myapp"')}${
          chalk.cyan(',')}`)
        console.log()
      }
      console.log(`The ${chalk.cyan('build_webpack')} folder is ready to be deployed.`)
